...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        att = att.masked_fill(self.bias[:, :, :T, :T] == 0, float(-20))
...
gptconf = GPTConfig(block_size = 112, vocab_size = 65, n_layer = 4, n_head = 4, n_embd = 64, dropout = 0.0, bias = False) 
model = GPT(gptconf)
